        ...
        <div class="basis-4/12 sticky px-2 py-2">
            <div class="mb-4">
                <div>
                    ...
                    <button wire:click="$dispatch('openModal', { component: 'edit-pendaftaran', arguments: { pendaftaranId: {{ $pendaftaran->id_pendaftaran }} }})" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Edit</button>
                    <button wire:click="$dispatch('openModal', { component: 'surat-penerimaan', arguments: { pendaftaranId: {{ $pendaftaran->id_pendaftaran }} }})" type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Surat</button>
                    <button wire:click="$dispatch('openModal', { component: 'delete-pendaftaran', arguments: { pendaftaranId: {{ $pendaftaran->id_pendaftaran }} }})" type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete</button>
                    <hr class="mb-4 h-2">
