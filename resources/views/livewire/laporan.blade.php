<div>
    {{-- loading --}}
    <div wire:loading.delay class="flex items-center justify-center">
    ...
    <div wire:loading.remove class="grid max-w-lg grid-cols-2 gap-4">
    ...
    <div wire:loading.remove class="grid h-24 gap-6 mt-4 mb-4 md:grid-cols-2 xl:grid-cols-3">
