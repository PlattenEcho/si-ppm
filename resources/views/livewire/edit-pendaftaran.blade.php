<div class="px-4 py-4 relative w-full max-h-[36rem] overflow-y-auto bg-white shadow-md sm:rounded-lg">
    ...
    <div class="mb-4">
        <div>
            ...
            <select id="selectedJenjang" name="selectedJenjang" wire:model='selectedJenjang'
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option>Pilih jenjang</option>
                @foreach ($keys as $key => $value)
                    <option value={{ $key }} wire:key="{{ $loop->index+1 }}"
                        @if ($key == $selectedJenjang) selected @endif>
                        {{ $value }}
                    </option>
                @endforeach
            </select>
    ...
    <div class="mb-4">
        ...
        <input
            ...
            aria-describedby="inputScanKtm" name="inputScanKtm" id="inputScanKtm" type="file"
            wire:model="inputScanKtm">
    ...
    <div class="mb-4">
        ...
        <input
            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
            aria-describedby="inputSuratPengantar" name="inputSuratPengantar" id="inputSuratPengantar"
            type="file" wire:model="inputSuratPengantar">
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">
            PNG,
            JPG, atau PDF (Max. 4MB).</p>
    ...
    <hr class="mb-4" />
    <button type="submit" wire:click='editPendaftaran' wire:loading.attr="disabled"
        ...
        <span wire:loading wire:target="editPendaftaran" class="animate-spin">&#x21bb;</span>
        <span wire:loading.remove>Edit Pendaftaran</span>
    </button>
